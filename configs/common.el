...
;; Backups
(defvar temp-folder-backup "~/.emacs.d/backup/")
(setq
  backup-directory-alist `((".*" . ,temp-folder-backup))
  auto-save-file-name-transforms `((".*" ,temp-folder-backup t))
...
;; Disable auto-save for encrypted files (source of pain)
