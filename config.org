...
#+begin_src emacs-lisp
  ...
  :custom
    ...
    (corfu-popupinfo-delay 0.2)  ; Automatically update info popup after that numver of seconds
...
As verb uses org mode as its default mode, map the verb-command-map when loading
org.
