...
(use-package flycheck-golangci-lint
  ...
  :config
  (setq flycheck-golangci-lint-enable-linters '("deadcode" "errcheck" "gofmt" "golint" "gosimple" "govet" "ineffassign" "staticcheck" "structcheck" "typecheck" "unused" "varcheck")
        flycheck-golangci-lint-deadline "1s"))
#+end_src
