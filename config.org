...
#+begin_src emacs-lisp               
  (use-package lsp-mode
    ...
    ;; completion
    (lsp-completion-provider :none)                ; Uses corfu when set to none, uses company when set to capf
...
[[https://github.com/minad/corfu][Corfu]] for auto completion.
