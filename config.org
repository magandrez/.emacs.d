...
#+begin_src emacs-lisp
(defun my/setup-typescript-env-and-lsp ()
  (my/load-direnv-env)
  ...
  (message "[env+lsp] Setting up TypeScript LSP.")
  (lsp-deferred))
#+end_src
...
(use-package lsp-mode
  :hook ((lsp-mode . lsp-enable-which-key-integration)
         (elixir-ts-mode . my/setup-elixir-env-and-lsp)
         (typescript-ts-mode . my/setup-typescript-env-and-lsp)
         (tsx-ts-mode . my/setup-typescript-env-and-lsp)
         (js-ts-mode . my/setup-typescript-env-and-lsp)
         (python-ts-mode . my/setup-python-env-and-lsp)
         (go-ts-mode . my/setup-go-env-and-lsp))
...
#+begin_src emacs-lisp
(defun my/setup-go-env-and-lsp ()
  (my/load-direnv-env)
  (message "[env+lsp] Setting up Go LSP.")
  (lsp-deferred)
...
This relies on the custom-made kludge that is defined in the section
"Environment".

#+begin_src emacs-lisp
(defun my/setup-elixir-env-and-lsp ()
  (my/load-direnv-env)
  (message "[env+lsp] Setting up Elixir LSP.")
  (lsp-deferred))
#+end_src
...
(keymap-set makefile-mode-map "C-o" #'casual-make-tmenu)
