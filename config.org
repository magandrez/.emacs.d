...
#+begin_src emacs-lisp
  (use-package lsp-mode
    ...
    (setq lsp-keymap-prefix "C-l"
          ...
          lsp-disabled-clients '(eslint angular-ls deno tfmls) ;; For Terraform, don't use tfls, but use Hashicorp's official implementation
    ...
    :hook (((go-mode clojure-mode clojurescript-mode) . lsp-deferred)
