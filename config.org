...
(setq-default inhibit-startup-screen t
              ...
              xref-search-program 'ripgrep            ; Ripgrep as default search program
              package-native-compile t
)
#+END_SRC
...
(use-package treemacs
  ...
  (setq treemacs-follow-after-init t
        ...
        treemacs-icon-fallback-background "#2d2d31"
        treemacs-hl-line-fallback-background "#2d2d31")
...
(use-package yasnippet
  ...
  :init
   ...
   (add-hook 'fish-mode #'yas-minor-mode)
